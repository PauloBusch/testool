...
namespace TesTool.Core.Enumerations
{
    public class SettingEnumerator : EnumeratorBase<SettingEnumerator, Setting>
    {
        ...
        public static readonly Setting MODEL_FAKER_FACTORY_NAME = new("MODEL_FACTORY_NAME");
        public static readonly Setting ENTITY_FAKER_FACTORY_NAME = new("ENTITY_FACTORY_NAME");
